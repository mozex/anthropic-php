...
final class ThreadMessageResponse implements ResponseContract, ResponseHasMetaInformationContract
{
    ...
    {
        $content = array_map(
            fn (array $content): \Anthropic\Responses\Threads\Messages\ThreadMessageResponseContentTextObject|\Anthropic\Responses\Threads\Messages\ThreadMessageResponseContentImageFileObject => match ($content['type']) {
