...
test('retrieve', function () {
    $client = mockClient('GET', 'models/claude-sonnet-4-6-20250514', [], \Anthropic\ValueObjects\Transporter\Response::from(modelRetrieve(), metaHeaders()));

    $result = $client->models()->retrieve('claude-sonnet-4-6-20250514');
